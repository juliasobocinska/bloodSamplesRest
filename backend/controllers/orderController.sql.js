...
const orderController = {
    ...
    handleOrder: async (req, res) => {
        try {
            ...
            const userOrders = await Order.getAllOrders(owner);
            ...
            if (userOrders && userOrders.length > 0) {
                ...
                if (diffInMonths < 6) {
                    return res.status(400).json({ status: 400, error: 'Możesz złożyć zamówienie na badania maksymalnie raz na pół roku!' });
                }
            }
